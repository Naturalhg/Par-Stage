...
Pour avoir un aperçu du site, il faut créer un compte ou se connecter à Replit, puis cliquer sur le bouton bleu "fork" (en haut à gauche) et renommer ce projet pour l'ajouter à "MyRepls".
Une fois ce projet ajouté, cliquer sur le bouton vert "run" (en haut de l'écran) et une "webview" s'affichera sur la droite de l'écran.
